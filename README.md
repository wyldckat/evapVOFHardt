...
The original source code was developped for OpenFOAM 2.1.1 and this repository aims to extend functionality to other OpenFOAM versions and variants.
...
These instructions are for OpenFOAM 2.1.1:
